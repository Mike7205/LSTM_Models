...
with col2:
    st.image("T5_v1.jpeg", caption="The T5 model (Text-To-Text Transfer Transformer) was developed by the research team at Google Research. It is one of the advanced language models designed to handle various language tasks by transforming them into text-based tasks")
